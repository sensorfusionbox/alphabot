...
Package with launch files and run-time configurations for alphabot
...
If you are familiar with ROS 2, here are the quick-and-dirty build instructions.
  ...
  git clone git@github.com:sensorfusionbox/alphabot_bringup.git src/alphabot_bringup
  vcs import src --input src/alphabot_bringup/alphabot_bringup.humble.repos
  vcs import src --input src/alphabot_bringup/alphabot_bringup.humble.upstream.repos
